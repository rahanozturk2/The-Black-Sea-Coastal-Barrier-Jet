...
GEO_CTRL = r"D:\Verisetleri\BCBJ\WRF\TEST1_348\geo_em.d02.nc"
GEO_NTER = r"D:\Verisetleri\BCBJ\WRF\TEST1_348\geo_em.d02_no_terrain.nc"
...
def draw_panel(ax, lon, lat, hgt, title, panel):
    ...
    ax.set_extent([26, 38, 38, 45], crs=ccrs.PlateCarree())
...
def make_two_panel():
    ...
    m2 = draw_panel(axs[1], lon_n, lat_n, hgt_n,
    ...
    fig.suptitle("WRF d02 terrain  -  Control vs No-Terrain sensitivity run",
